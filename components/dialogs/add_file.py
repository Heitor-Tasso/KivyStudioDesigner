...
class AddFileDialog(BoxLayout):
    ...
    def _perform_add_file(self):
        ...
        try:
            path = os.path.join(folder, os.path.basename(self.text_file.text))
            shutil.copy(self.text_file.text, path)
    ...
    def open_folder_btn_pressed(self, *args):
        ...
        '''
        XFolder(
            title="Open Folder", on_dismiss=self._folder_load,
